...
const MEDIA = {
  ...
  /* Homepage hero — the Stop Human Trafficking campaign photo (2026).
     The filename must change whenever the photo does: /uploads/* is served
     with a week-long browser cache, so reusing a name shows stale images. */
  "/wp-content/uploads/2026/07/tkk-network-2026.jpg": ["/uploads/hero-stop-campaign.jpg", join(repo, "assets/site-src/images/tkk-stop-campaign-2026.jpg")],
...
await page("/", shell({
  ...
  canonical: "/", image: "/uploads/hero-stop-campaign.jpg",
